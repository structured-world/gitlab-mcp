...
[![Install in Claude Desktop](https://img.shields.io/badge/Claude_Desktop-Install_Extension-F97316?style=for-the-badge)](https://gitlab-mcp.sw.foundation/downloads/gitlab-mcp-10.0.0.mcpb)
...
See [CONTRIBUTING.md](https://github.com/structured-world/gitlab-mcp/blob/HEAD/CONTRIBUTING.md) for development setup, testing, and PR guidelines.

## Support the Project

<div align="center">

![USDT TRC-20 Donation QR Code](https://raw.githubusercontent.com/structured-world/gitlab-mcp/HEAD/packages/gitlab-mcp/assets/usdt-qr.svg)
...
Apache License 2.0 — see [LICENSE](https://github.com/structured-world/gitlab-mcp/blob/HEAD/LICENSE) for details.

Based on [zereight/gitlab-mcp](https://github.com/zereight/gitlab-mcp) (MIT). See [LICENSE.MIT](https://github.com/structured-world/gitlab-mcp/blob/HEAD/LICENSE.MIT).
