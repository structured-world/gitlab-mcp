  ...
  [
    'browse_merge_requests',
    {
      ...
      requirements: {
        default: { tier: 'free' },
        actions: {
          approvals: { tier: 'premium', notes: 'MR approvals' },
        },
      },
  ...
  [
    'manage_merge_request',
    {
      ...
      requirements: {
        default: { tier: 'free' },
        actions: {
          approve: { tier: 'premium', notes: 'MR approvals' },
          unapprove: { tier: 'premium', notes: 'MR approvals' },
          get_approval_state: { tier: 'premium', notes: 'MR approval state' },
        },
      },
      gate: { envVar: 'USE_MRS', defaultValue: true },
      handler: async (args: unknown) => {
  ...
  [
    'manage_mr_discussion',
    {
      ...
      requirements: {
        default: { tier: 'free' },
        actions: {
          resolve: { tier: 'free', notes: 'Resolve discussion threads' },
          suggest: { tier: 'free', notes: 'Code suggestions' },
        },
      },
      gate: { envVar: 'USE_MRS', defaultValue: true },
      handler: async (args: unknown) => {
