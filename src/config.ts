...
export const GITLAB_DENIED_TOOLS_REGEX = process.env.GITLAB_DENIED_TOOLS_REGEX
  ...
  : undefined;
export const USE_GITLAB_WIKI = process.env.USE_GITLAB_WIKI === "true";
export const USE_MILESTONE = process.env.USE_MILESTONE === "true";
export const USE_PIPELINE = process.env.USE_PIPELINE === "true";
export const USE_WORKITEMS = process.env.USE_WORKITEMS === "true";
