...
// Import tool arrays
import { variablesReadOnlyToolsArray } from './tools-readonly';
import { variablesWriteTools } from './tools';
import type { ToolDefinition } from '../../types';

// Create combined or read-only tools array based on environment
export const variablesTools: ToolDefinition[] = isReadOnly
  ? variablesReadOnlyToolsArray
  : [...variablesReadOnlyToolsArray, ...variablesWriteTools];
