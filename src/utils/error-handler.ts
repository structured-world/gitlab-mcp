...
export function classifyError(error: unknown): ErrorCategory {
  ...
  // Check for HTTP status codes FIRST — prevents false transient classification
  // when a GitLab API error message contains "timeout" (e.g., "400 Bad Request -
  ...
  // Free-text fallback for non-GitLab/network errors (no parseable HTTP status).
