  ...
  describe('ListWikiPagesSchema', () => {
    ...
    it('should validate pagination parameters', async () => {
      ...
      const paginationParams = {
        project_id: testProject.id.toString(), // Required: exactly one of project_id or group_id
        per_page: 5,
        page: 2,
        with_content: false,
      };
  ...
  describe('GetWikiPageSchema', () => {
    it('should validate get wiki page parameters with real data', async () => {
      ...
      if (result.success) {
        ...
        // Note: render_html is not part of the parsed schema data for GetWikiPageSchema
        expect(result.success).toBe(true);
      }
