/**
 * GitLab MCP Server Transport Integration Tests
...
import {
  ...
  checkHealthEndpoint,
  HOST,
} from "../utils/server-launcher";
import { StdioTestClient } from "../clients/stdio-client";
import { SSETestClient } from "../clients/sse-client";
import { StreamableHTTPTestClient } from "../clients/streamable-http-client";
import { MCPClientInterface } from "../clients/client";
import type { ListToolsResult } from "@modelcontextprotocol/sdk/types.js";

console.log("🚀 GitLab MCP Server Integration Tests");
console.log("");
...
describe("GitLab MCP Server - Stdio Transport", () => {
  ...
  before(async () => {
    ...
    const serverPath = path.resolve(process.cwd(), "dist/src/main.js");
