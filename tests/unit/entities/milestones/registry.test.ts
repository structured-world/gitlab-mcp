...
describe("Milestones Registry - CQRS Tools", () => {
  ...
  describe("Handler Tests", () => {
    ...
    describe("browse_milestones handler - get action", () => {
      it("should get milestone by milestone_id", async () => {
        mockEnhancedFetch.mockResolvedValueOnce(
          mockResponse({ id: 1, path: "test-project", kind: "project" }) as never
        );
        const mockMilestone = {
    ...
    describe("browse_milestones handler - issues action", () => {
      it("should list issues in milestone by milestone_id", async () => {
        mockEnhancedFetch.mockResolvedValueOnce(
          mockResponse({ id: 1, path: "test-project", kind: "project" }) as never
        );
        const mockIssues = [
    ...
    describe("browse_milestones handler - merge_requests action", () => {
      it("should list merge requests in milestone by milestone_id", async () => {
        mockEnhancedFetch.mockResolvedValueOnce(
          mockResponse({ id: 1, path: "test-project", kind: "project" }) as never
        );
        const mockMRs = [
    ...
    describe("browse_milestones handler - burndown action", () => {
      it("should get burndown events by milestone_id", async () => {
        mockEnhancedFetch.mockResolvedValueOnce(
          mockResponse({ id: 1, path: "test-project", kind: "project" }) as never
        );
        const mockEvents = [
    ...
    describe("manage_milestone handler - update action", () => {
      it("should update milestone by milestone_id", async () => {
        mockEnhancedFetch.mockResolvedValueOnce(
          mockResponse({ id: 1, path: "test-project", kind: "project" }) as never
        );
        const mockMilestone = {
    ...
    describe("manage_milestone handler - delete action", () => {
      it("should delete milestone by milestone_id", async () => {
        mockEnhancedFetch.mockResolvedValueOnce(
          mockResponse({ id: 1, path: "test-project", kind: "project" }) as never
        );
    ...
    describe("manage_milestone handler - promote action", () => {
      it("should promote project milestone to group by milestone_id", async () => {
        mockEnhancedFetch.mockResolvedValueOnce(
          mockResponse({ id: 1, path: "test-project", kind: "project" }) as never
        );
        const mockMilestone = {
