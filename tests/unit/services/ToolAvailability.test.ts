...
describe('ToolAvailability - Tier-based Filtering', () => {
  ...
  describe('Error Handling', () => {
    ...
    it('should return null from getUnavailableReason when version is unknown', () => {
      // Mirror the isToolAvailable unknown-version fast-path:
      ...
      expect(ToolAvailability.isToolAvailable('browse_projects')).toBe(true);
      expect(ToolAvailability.getUnavailableReason('browse_projects')).toBeNull();
    });
  });
